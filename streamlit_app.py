    ...
    if prefix == "사전진단":
        ...
        <div style="background-color:#f9f9f9; border-radius:10px; padding:0.6rem; margin-bottom:1rem;">
            ...
            <table style="border-collapse:collapse; width:100%; margin-top:0.3rem; text-align:center; font-size:{font_size};">
                ...
                <tr>
                    <td colspan="2" style="border:1px solid black; padding:{padding}; height:{height}; background-color:#f9f9f9;">{user.iloc[complete1_col_idx]}</td>
                    <td colspan="2" style="border:1px solid black; padding:{padding}; height:{height}; background-color:#f9f9f9;">{user.iloc[complete2_col_idx]}</td>
                </tr>
            </table>
        </div>
        """
